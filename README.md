...
| 数学 × 高中解析几何 | 圆锥曲线统一(R=ed,e<1 椭圆/e=1 抛物线/e>1 双曲线) · 椭圆解析(x²/a²+y²/b²=1, PF₁+PF₂=2a, 离心率 e=c/a, 参数方程 x=a·cosθ y=b·sinθ) · 双曲线解析 · 抛物线解析 · 参数方程(摆线/星形线/渐开线) · 极坐标曲线(玫瑰/心形/阿基米德螺线) _(人教版选择性必修第一册)_ |
