...
- [~] **MATH-016** · 初中几何场景集(8 场景)
  ...
  - 候选清单(8 场景,user 可调):
    - [x] 31 `triangle-congruence` · 三角形全等判定 SSS/SAS/ASA/AAS(7 年级) · v0.6.36 落地
  ...
  - 进度: 1/8(2026-08-26 完成 31;剩 7 场景分批)
  - 创建: 2026-08-25
  - 依赖: 无(纯新增,不改现有 30 场景)
...
- **本轮改动**: (1) **MATH-016 第 1 步完成 v0.6.36:31 triangle-congruence 落地**(7 年级,5 判定法 SSS/SAS/ASA/AAS/HL + 2 个 3-4-5 直角三角形高亮对比) (2) viewer.js SCENES 加 31 项,30→31 (3) AGENTS 状态速览 30/30→31/31 + 里程碑加 v0.6.36 (4) .Log/2026-08-26.md 能力 append(按 v0.6.34 规则)
